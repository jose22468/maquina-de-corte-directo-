...
function initCharts() {
    ...
    // Establecer dimensiones fijas para las gráficas
    chartCanvas.width = 400;
    chartCanvas.height = 250;
    mohrCanvas.width = 400;
    mohrCanvas.height = 250;
...
// Manejo de errores global y limpieza
...
window.addEventListener('error', function(e) {
    console.error('Error global en la simulación:', e.error);
    if (animationId) {
        cancelAnimationFrame(animationId);
        animationId = null;
    }
